#ifndef RDYN_CORE__KINEMATICS_SATURATION_IMPL__H
#define RDYN_CORE__KINEMATICS_SATURATION_IMPL__H
...
template<typename D1>
inline bool saturatePosition(const rdyn::Chain& chain, Eigen::MatrixBase<D1>& q_next, std::stringstream* report)
{
...
inline bool saturateSpeed(const rdyn::Chain& chain, double& qd_next, double max_velocity_multiplier,
...
inline bool saturateSpeed(const rdyn::Chain& chain, double& qd_next, const double& qd_actual, double dt,
...
inline bool saturateSpeed(const rdyn::Chain& chain, double& qd_next, const double& qd_actual, const double& q_actual,
...
inline bool saturatePosition(const rdyn::Chain& chain, double& q_next, std::stringstream* report)
{
...
#endif  // RDYN_CORE__KINEMATICS_SATURATION_IMPL__H