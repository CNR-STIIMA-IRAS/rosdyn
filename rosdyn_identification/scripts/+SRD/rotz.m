function TF = rotz( q,ext_coord,fixed )
if nargin<2
    ext_coord=q;
end
if nargin<3
...
TF(1,1)=c;    TF(1,2)=-s;   TF(1,3)=zero; TF(1,4)=zero;
TF(2,1)=s;    TF(2,2)=c;    TF(2,3)=zero; TF(2,4)=zero;
TF(3,1)=zero; TF(3,2)=zero; TF(3,3)=one;  TF(3,4)=zero;
